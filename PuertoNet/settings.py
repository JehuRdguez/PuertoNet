"""
Django settings for PuertoNet project.
...
SECRET_KEY = 'django-insecure-7p)0+))y$$c)%izmt3ynlfq1w217=k4l2mg*co)yp+r#)%63=v'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'mainApp.context_processors.tinymce_api_key',
...
WSGI_APPLICATION = 'PuertoNet.wsgi.application'
